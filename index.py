...
def mi_funcion():
    ...
    allin = bool(input("¿Es all-in? (True/False): "))
        ...
        if rivales == 2:
            ...
            if posicion_rival == "bb" and posicion == "sb":
                if allin == False:
                    ...
                    if bb in [17,18,19,20,21,22,23,24,25]:
                        if cartas[0][0] == "A" and cartas[1][0] == "A":
                            return print("Call")
                        elif cartas[0][0] == "A" and cartas[1][0] == "K":
                            return print("Call")
                            ...
                            return print("Call")
                        elif cartas[0][0] == "K" and cartas[1][0] == "Q" and suited == True:
                            return print("Call")
                        elif cartas[0][0] == "K" and cartas[1][0] == "J" and suited == True:
                            return print("Call")
                        elif cartas[0][0] == "K" and cartas[1][0] == "T" and suited == True:
                            ...
                            return print("Call")
                        elif cartas[0][0] == "Q" and cartas[1][0] == "J" and suited == True:
                            return print("Call")
                        elif cartas[0][0] == "Q" and cartas[1][0] == "T" and suited == True:
                            return print("Call")
                    ...
                    if bb in [9,10,11,12,13,14,15,16]:
                        if cartas[0][0] == "A" and cartas[1][0] == "A":
                            return print("Call")
                        elif cartas[0][0] == "A" and cartas[1][0] == "K" and suited == True:
                            return print("Call")
                    ...
                    if bb in [7,8]:
                        if cartas[0][0] == "A" and cartas[1][0] == "A":
                            ...
                            return print("Call")
                        elif cartas[0][0] == "Q" and cartas[1][0] == "9" and suited == True:
                            return print("Call")
